    ...
    class TCS34725
    {
        ...
        public async Task Initialize()
        {
            ...
            try
            {
                ...
                _colorSensor = await I2cDevice.FromIdAsync(dis[0].Id, settings);
        ...
        private async Task begin()
        {
            ...
            _colorSensor.WriteRead(WriteBuffer, ReadBuffer);
